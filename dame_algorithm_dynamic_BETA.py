...
This is SUPER UNDER DEVELOPMENT
Me trying to make the selection of best covariate as dynamic. 
"""
...
def algo1(df_all, treatment_column_name = "T", weights = [],
    ...
    while True:
        ...
        for s in active_covar_sets: # s is a set to consider dropping
            new_mse = match_quality.compute_mse(df_all, all_covs, s, weights,
                                                outcome_column_name)
            if new_mse <= min_mse:
                min_mse = new_mse
